# Generated by Django 5.1.3 on 2025-09-22 04:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('has_meter', models.BooleanField(default=True)),
                ('calle', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='agua.calle')),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='customers', to='agua.category')),
                ('zona', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='agua.zona')),
            ],
        ),
        migrations.CreateModel(
            name='Debt',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('concept', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='agua.cashconcept')),
                ('invoice_payment', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='cash_movements', to='agua.invoicepayment')),
            ],
        ),
        migrations.CreateModel(
            name='Reading',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('total', models.DecimalField(decimal_places=2, default=0.0, max_digits=10)),
                ('debt', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='invoice_links', to='agua.debt')),
                ('invoice', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='invoice_debts', to='agua.invoice')),
            ],
            options={
